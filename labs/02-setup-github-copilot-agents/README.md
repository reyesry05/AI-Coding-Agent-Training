...
- confirm whether Ask, Plan, and Agent are available in your environment
...
- Ask, Plan, and Agent confirmed as available, or the reason they are unavailable documented
- one safe Ask, Plan, and Agent interaction completed
...
Goal of the step:
- Determine whether Ask, Plan, and Agent are available.

Exact action:
- Open Chat with Ctrl+Alt+I.
- Look for Ask, Plan, and Agent in the agent picker.
...
Goal of the step:
- Practice Ask, Plan, and Agent in a controlled order.
...
- I can verify whether Ask, Plan, and Agent are available in my environment.
...
- Ask, Plan, and Agent available, or a documented reason they are unavailable
