# Presenter Deck: First Safe Prompts For Ask, Edit, Plan, And Agent
...
- Choose Ask, Edit, Plan, or Agent appropriately
...
## Slide 4. Ask, Edit, Plan, And Agent At A Glance
...
- Position Ask as the lowest-risk starting point, Edit as the next step up for targeted changes, and Agent as the highest-autonomy option.
