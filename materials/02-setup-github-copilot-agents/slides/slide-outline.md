...
- Show the difference in risk and output across the four modes.
...
- Keep the outline aligned with the presenter deck when internal prerequisites or repository assumptions change.
