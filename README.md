...
- `labs/` for hands-on exercises, starter state, and solution guidance
- `references/` for shared factual reference documents
...
- `materials/09-research-and-building-blocks/README.md`
- `materials/10-cli-tools-and-terminal-workflows/README.md`
- `materials/11-understanding-mcp-servers/README.md`
...
- `labs/09-research-and-building-blocks/README.md`
- `labs/10-cli-tools-and-terminal-workflows/README.md`
- `labs/11-understanding-mcp-servers/README.md`
