...
- Look for built-in options such as Ask, Plan, and Agent.

What success looks like:
- The learner can switch between Ask, Plan, and Agent in the Chat view.
...
What success looks like:
- The learner experiences Ask, Plan, and Agent in a controlled sequence.
...
3. Open Chat and confirm whether Ask, Plan, and Agent are available.
...
- The learner can identify Ask, Plan, and Agent in VS Code, or explain why agents are unavailable in their environment.
